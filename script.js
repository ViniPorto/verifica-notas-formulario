...
function verificar() {
  ...
  localStorage.setItem(
    "1-nota-1-bimestre",
    document.getElementById("1-nota-1-bimestre").value
  );
  localStorage.setItem(
    "2-nota-1-bimestre",
    document.getElementById("2-nota-1-bimestre").value
  );
  localStorage.setItem(
    "3-nota-1-bimestre",
    document.getElementById("3-nota-1-bimestre").value
  );
  localStorage.setItem(
    "1-nota-2-bimestre",
    document.getElementById("1-nota-2-bimestre").value
  );
  localStorage.setItem(
    "2-nota-2-bimestre",
    document.getElementById("2-nota-2-bimestre").value
  );
  localStorage.setItem(
    "3-nota-2-bimestre",
    document.getElementById("3-nota-2-bimestre").value
  );
  localStorage.setItem(
    "num-faltas",
    document.getElementById("num-faltas").value
  );
  ...
  //presença
  let presenca =
    ((numeros_de_aulas - numeros_de_faltas) / numeros_de_aulas) * 100; //retorna o valor da *porcentagem*
  ...
  if (media_semestral >= 7 && presenca >= 75) {
    ...
    localStorage.setItem(
      "nota-exame",
      document.getElementById("nota-exame").value
    );

    //carregar informações nos inputs
    document.getElementById("1-nota-1-bimestre").value =
      localStorage.getItem("1-nota-1-bimestre");
    document.getElementById("2-nota-1-bimestre").value =
      localStorage.getItem("2-nota-1-bimestre");
    document.getElementById("3-nota-1-bimestre").value =
      localStorage.getItem("3-nota-1-bimestre");
    document.getElementById("1-nota-2-bimestre").value =
      localStorage.getItem("1-nota-2-bimestre");
    document.getElementById("2-nota-2-bimestre").value =
      localStorage.getItem("2-nota-2-bimestre");
    document.getElementById("3-nota-2-bimestre").value =
      localStorage.getItem("3-nota-2-bimestre");
    document.getElementById("num-faltas").value =
      localStorage.getItem("num-faltas");
    document.getElementById("num-aulas").value =
      localStorage.getItem("num-aulas");
  }
}
